...
<main class="align-middle form-signin">
  <form method="POST">
    ...
    <div class="form-floating">
      <input type="text" name="name" class="form-control" required id="floatingName" placeholder="name">
    ...
    <div class="form-floating">
      <input type="password" name="passwd" class="form-control" required id="floatingPassword" placeholder="Password">
